        ...
        <div className="space-y-5">
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input name="companyEmail" value={form.companyEmail} onChange={handleChange} placeholder="company@email.com" className="input-field" />
              </div>
              <div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="label">Phone</label>
                <input name="customerPhone" value={form.customerPhone} onChange={handleChange} placeholder="Mobile number" className="input-field" />
              </div>
              <div>
                <label className="label">Email</label>
                <input name="customerEmail" value={form.customerEmail} onChange={handleChange} placeholder="Email address" className="input-field" />
              </div>
              <div className="col-span-2">
                <label className="label">Address</label>
                <input name="customerAddress" value={form.customerAddress} onChange={handleChange} placeholder="Full address" className="input-field" />
              </div>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="col-span-2">
                ...
                <textarea name="serviceType" value={form.serviceType} onChange={handleChange}
                  placeholder="Describe the service work done..." rows={2} className="input-field resize-none" />
              </div>
              <div>
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" onClick={() => setSpareRows([...spareRows, emptySpare()])}
                  className="text-emerald-400 text-xs hover:text-emerald-300">+ Add Row</button>
              </div>
                    ...
                    {spareRows.map((row, idx) => (
                      <tr key={idx} className="border-t border-slate-700">
                        <td className="px-2 py-1.5">
                          <input value={row.description} onChange={(e) => handleSpareChange(idx, 'description', e.target.value)}
                            placeholder="Spare part name" className="input-field text-xs py-1.5" />
                        </td>
                        <td className="px-2 py-1.5 w-16">
                          <input type="number" value={row.qty} onChange={(e) => handleSpareChange(idx, 'qty', e.target.value)}
                            className="input-field text-xs py-1.5" min="1" />
                        </td>
                        <td className="px-2 py-1.5 w-24">
                          <input type="number" value={row.unitPrice} onChange={(e) => handleSpareChange(idx, 'unitPrice', e.target.value)}
                            placeholder="0" className="input-field text-xs py-1.5" />
                        </td>
                        <td className="px-2 py-1.5 text-emerald-400 text-xs font-semibold w-20">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <button type="button" onClick={() => setOtherRows([...otherRows, emptyOther()])}
                  className="text-emerald-400 text-xs hover:text-emerald-300">+ Add Row</button>
              </div>
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => setShowPreview(!showPreview)} className="btn-secondary px-6">
              👁 Preview
            </button>
          </div>
        </div>
